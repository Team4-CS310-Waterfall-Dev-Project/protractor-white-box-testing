describe('access through web browser', function() {
    ...
    //The user should be able to access the webapp through a link on the web

    //The application should be on a public website

    //The loading time of the website should be less than MSLT
